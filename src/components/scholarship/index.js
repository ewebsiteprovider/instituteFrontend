...
export default function Scholarship() {
  return (
    <div className="h-[calc(100%_-_60px)] overflow-auto text-center">
      <BannerForm />
      <h1 className="title">Motion Open Scholarship Test (MOST)</h1>
      <div className="flex flex-wrap justify-center">
        <div className="p-[16px] m-[16px] w-[40%] rounded-[12px] border h-[250px]">
      ...
      <div className="px-[180px]">
        <h1 className="title">Why should you choose MOST?</h1>
